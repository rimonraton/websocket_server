    ...
    >
        ...
        >
            <nav class="flex items-center justify-end gap-4">
                <Link
                    href="/chat"
                    class="inline-block rounded-sm border border-transparent px-5 py-1.5 text-sm leading-normal text-[#f53003] hover:border-[#f5300335] dark:text-[#FF4433] dark:hover:border-[#FF443335]"
                >
                    Test Chat
                </Link>
                <Link
